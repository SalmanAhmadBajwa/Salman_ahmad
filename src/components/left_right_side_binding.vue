    ...
    <v-layout style="width: 100vw; background-color: #d8d8d8" class="mt-9">
      ...
      >
        <template v-slot:activator="{ on, attrs }">
          <v-btn icon v-on="on" v-bind="attrs" style="margin-top:0.5em;" class="ml-2">
         <v-icon small  >mdi-dots-horizontal-circle-outline</v-icon></v-btn>
        </template>
       <v-card
                              elevation="0"
                              width="374"
                              ...
                              outlined
                            >
                                <div style="width:28em" class="mt-4 ml-2 mb-2">
                                  <v-card
                                    elevation="0"
                                    outlined
                                    max-width="340"
                                        ...
                                        <v-expansion-panel-content>
                                         ...
                                         <v-list flat dense>
                                           <v-list-item
                                            ...
                                            v-for="(item11,index) in cardfiledsitems" :key="index">
                                             <v-list-item-icon class="pl-2">
                                             <v-icon v-text="item11.icon" >{{item11.icon}}</v-icon>
                                             </v-list-item-icon>
                                             <v-list-item-content>
                                               <v-list-item-subtitle v-text="item11.title">
                                ...
                                <div v-if="cardfiledshow==='Text Field'" style="width:24em" class="ml-6">
                               <div style="display:flex;" v-for="(item1,index) in Text_filed_items" :key="index"  class="ml-3" >
                                 <v-btn icon class="mt-n2" @click="textfiledfunc(item1)">
                                   <v-icon small >{{item1.icon}}</v-icon>
                                 </v-btn>
                                 <p class="ml-2" style="cursor:pointer" v-if="item1.value && item1.title" @click="textfiledfunc(item1)">{{item1.title}}</p>
                                 <p class="ml-2" v-if="item1.value && !item1.title && item1.type==='text-field'">Enter Statement</p>
                                 <p class="ml-2" v-if="item1.value && !item1.title && item1.type==='label'">Add Label</p>
                                  <v-text-field
                                   v-if="!item1.value && item1.type==='text-field'"
                                  dense
                                  ...
                                  <div v-if="!item1.value && item1.type==='slider'" style="width:22em" class="mb-n3 mt-n1">
                                  <v-slider
                                   max="12"
  min="3"
     ...
     :track-color="maincolor.bar"
      ...
      ></v-slider></div>
              ...
              <v-btn
                class="mt-n4 mr-5 "
                style="text-transform: none;font-family:raleway; font-size: 14px; font-weight: 700;color:#474747"
                text
              ...
              >
               Anlegen
                                ...
                                <div v-if="cardfiledshow==='Check Boxes'"  style="width:24em" class="ml-6">
                               <div style="display:flex;" v-for="(item3,index) in checkbox_items" :key="index"  class="ml-3" >
                                 <v-btn icon class="mt-n2" @click="checkboxfunc(item3)">
                                   <v-icon small >{{item3.icon}}</v-icon>
                                 </v-btn> 
                                 <p class="ml-2" style="cursor:pointer" v-if="item3.value && item3.title" @click="checkboxfunc(item3)">{{item3.title}}</p>
                                 <p class="ml-2" v-if="item3.value && !item3.title && item3.type==='text-field'">Enter Statement</p>
                                   <p class="ml-2" v-if="item3.value && !item3.title && item3.type==='label'">Add Label</p>
                                 <p class="ml-2" v-if="item3.value && !item3.title && item3.type==='right-side-text'">Add Right Side Text</p>
                               
                                  <v-text-field
                                   v-if="!item3.value && item3.type==='text-field'"
                                  dense
                                  class="mt-n2 mr-4 mb-n3"
                                  outlined
                                  rounded
                                  ...
                                  <v-text-field
                                   v-if="!item3.value && item3.type==='right-side-text'"
                                  dense
                                  class="mt-n2 mr-4 mb-n3"
                                  outlined
                                  rounded
              ...
              >
               Anlegen
                                ...
                                <div v-if="cardfiledshow==='Drop Down'"  style="width:24em" class="ml-6">
                               <div style="display:flex;" v-for="(item4,index) in drop_down_items" :key="index"  class="ml-3" >
                                 <v-btn icon class="mt-n2" @click="dropdownfunc(item4)">
                                   <v-icon small >{{item4.icon}}</v-icon>
                                 </v-btn> 
                                 <p class="ml-2" style="cursor:pointer" v-if="item4.value && item4.title" @click="dropdownfunc(item4)">{{item4.title}}</p>
                                 <p class="ml-2" v-if="item4.value && !item4.title && item4.type==='text-field'">Enter Statement</p>
                                   <p class="ml-2" v-if="item4.value && !item4.title && item4.type==='drop-down-option'">Add Drop Down Option</p>
                               
                                  <v-text-field
                                   v-if="!item4.value && item4.type==='text-field'"
                                  dense
                                  class="mt-n2 mr-4 mb-n3"
                                  outlined
                                  rounded
                                  ...
                                  <v-text-field
                                   v-if="!item4.value && item4.type==='drop-down-option'"
                                  dense
                                  class="mt-n2 mr-4 mb-n3"
                                  outlined
                                  rounded
              ...
              <v-btn
                ...
                style="text-transform: none;font-family:raleway; font-size: 14px; font-weight: 700;color:#474747"
                text
               @click="dropdownoptionitemssubmission(item.id)"
              >
               Anlegen
              </v-btn>
            </v-card-actions>
                               </div>
                               <div v-if="cardfiledshow==='Radio Button'"  style="width:24em" class="ml-6">
                               <div style="display:flex;" v-for="(item5,index) in radio_button_items" :key="index"  class="ml-3" >
                                 <v-btn icon class="mt-n2" @click="radiobuttonfunc(item5)">
                                   <v-icon small >{{item5.icon}}</v-icon>
                                 </v-btn> 
                                 <p class="ml-2" style="cursor:pointer" v-if="item5.value && item5.title" @click="radiobuttonfunc(item5)">{{item5.title}}</p>
                                 <p class="ml-2" v-if="item5.value && !item5.title && item5.type==='text-field'">Enter Statement</p>
                                   <p class="ml-2" v-if="item5.value && !item5.title && item5.type==='label'">Add Label</p>
                                 <p class="ml-2" v-if="item5.value && !item5.title && item5.type==='right-side-text'">Add Radio text on Right Side </p>
                               
                                  <v-text-field
                                   v-if="!item5.value && item5.type==='text-field'"
                                  dense
                                  class="mt-n2 mr-4 mb-n3"
                                  outlined
                                  rounded
                                  ...
                                  <v-text-field
                                   v-if="!item5.value && item5.type==='right-side-text'"
                                  dense
                                  class="mt-n2 mr-4 mb-n3"
                                  outlined
                                  rounded
               ...
               Anlegen
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                <strong  :inner-html.prop="item.name | truncateEnd(38)"></strong>
                                </p>
                              </v-list-item>
                            </v-list>
                            <v-list v-if="item.name_edit" class="mt-3 mb-n3" style="background-color:transparent"> 
                              <v-list-item
                                v-for="color in ['transparent']"
                                :key="color"
                                v-ripple="{ class: `${color}--text` }"
                                ...
                                <div v-if="item1.isStrong === true">
                                  <div v-if="item1.heading_property_number">
                                    <div
                                      v-if="item1.tiptapedit"
                                      v-on:dblclick="
                                        taptapeditoractivateright1(item1)
                                      "
                                    >
                                      <!-- <tiptap-vuetify
                                        spellcheck="false"
            ...
            <icon name="code" />
                                  ...
                                  <div v-else>
                                    <div
                                      v-if="item1.tiptapedit"
                                      v-on:dblclick="
                                        taptapeditoractivateright2(item1)
                                      "
                                    >
                                      <!-- <tiptap-vuetify
                                        spellcheck="false"
                                ...
                                <div v-else>
                                  ...
                                  >
                                    <div
                                      v-if="item1.tiptapedit"
                                      v-on:dblclick="
                                        taptapeditoractivateright3(item1)
                                      "
                                    >
                                      <!-- <tiptap-vuetify
                                        spellcheck="false"
                               ...
                               <div :inner-html.prop="item1.display"></div>
                                  ...
                                  <div v-else>
                                    <div
                                      v-if="item1.tiptapedit"
                                      v-on:dblclick="
                                        taptapeditoractivateright4(item1)
                                      "
                                    >
                                      <!-- <tiptap-vuetify
                                        spellcheck="false"
...
export default {
  ...
  data: () => ({
    radio_button_items:[
        {id:1,title:"",icon:"mdi-text-short",value:true,type:"text-field"},
  ...
  methods: {
    radiobuttonfunc(x){
       if(x.title==='Add Another Radio Field'){
        ...
        this.radio_button_items=JSON.parse(JSON.stringify(this.radio_button_items))
        var multi_radio_button_items;
        multi_radio_button_items=[  
          {id:2,title:"",icon:"mdi-label-outline",value:true,type:"label"},
       {id:3,title:"",icon:"mdi-tag-text-outline",value:true,type:"right-side-text",},
    ],
        multi_radio_button_items=JSON.parse(JSON.stringify(multi_radio_button_items))
    ...
    radiobuttonitemssubmission(x){
      ...
      var statement_id = "s" + (ids.section.length + 1)
      var obj3 = {
                      textfieldapproval: false,
                      dropselect_display: false,
                      fields_display: true,
      ...
      let right_side_text_filter = items.filter(o => o.type === 'right-side-text');
   ...
   this.radio_button_items=[
    ...
    dropdownfunc(x){
      if(x.title==='Add Another drop-down-option'){
        ...
        multi_drop_down_items=JSON.parse(JSON.stringify(multi_drop_down_items))
     ...
     dropdownoptionitemssubmission(x){
      ...
      ids.total_fields = ids.total_fields+1
      var statement_id = "s" + (ids.section.length + 1)
      let drop_down_option_filter = items.filter(o => o.type === 'drop-down-option');
     var drop_down_option_filter_array_values = []
      for(var i=0;i<drop_down_option_filter.length; i++){
        drop_down_option_filter_array_values.push(drop_down_option_filter[i].title)
      }
      var obj3 ={
                      tiptapedit: false,
                      eid: statement_id,
   ...
   this.cardfiledshow="";
    ...
    checkboxfunc(x){
      if(x.title==='Add Another Checkbox'){
       ...
       {id:3,title:"",icon:"mdi-tag-text-outline",value:true,type:"right-side-text",},
        ...
        multi_checkbox_items=JSON.parse(JSON.stringify(multi_checkbox_items))
    ...
    textfiledfunc(x){
      if(x.title==='Add more than one text-filed for one statement'){
        ...
        this.Text_filed_items=JSON.parse(JSON.stringify(this.Text_filed_items))
        var multi_Text_filed_items;
        multi_Text_filed_items=[  
      {id:2,title:"",icon:"mdi-label-outline",value:true,type:"label"},
       {id:3,title:"Add Size of Text Filed",icon:"mdi-arrow-left-right-bold-outline",value:true,type:"slider",slidervalue:"6",},
    ],
        multi_Text_filed_items=JSON.parse(JSON.stringify(multi_Text_filed_items))
    ...
    adjust_front_end_inner_heading_value_display(inner_heading_value,display){
      ...
      //console.log(tag_for_front_heading_value_front)
      //console.log(tag_for_front_heading_value_end)
      ...
      //console.log(inner_heading_value_display)
      ...
      // }
      // console.log(tags_in_a_string_from_front.length)
      // console.log(tags_in_a_string_from_end.length)
      ...
      for (i = 0; i < this.document.rightSide.card.length; i++) {
        for (j = 0; j < this.document.rightSide.card[i].section.length; j++) {
          if(this.document.rightSide.card[i].section[j].tiptapedit === true){
            ...
            this.document.rightSide.card[i].section[j].dependent_values[0].display=this.editor2.view.docView.contentDOM.innerHTML;
          }
      ...
      for (i = 0; i < this.document.leftSide.card.length; i++) {
        for (j = 0; j < this.document.leftSide.card[i].section.length; j++) {
          ...
          if (this.document.leftSide.card[i].section[j].tiptapedit === true) {
            this.document.leftSide.card[i].section[j].statement=this.editor1.view.docView.contentDOM.innerHTML;
          ...
          if (
            ...
            for (
              ...
              if (
                ...
                this.document.leftSide.card[i].section[j].fields[
                  k
                ].line = this.editor1.view.docView.contentDOM.innerHTML;
                this.document.leftSide.card[i].isedited = true;
              }
            }
            if (
              ...
              if (
                ...
                this.document.leftSide.card[i].section[
                 ...
                 this.document.leftSide.card[i].section[
                  j
                ].dropselect[0].statement = this.editor1.view.docView.contentDOM.innerHTML;
                this.document.leftSide.card[i].isedited = true;
              }
            }
            if (
              ...
              if (
                ...
                this.document.leftSide.card[i].section[
                  j
                ].textfieldapprovalfields[0].statement = this.editor1.view.docView.contentDOM.innerHTML;
                this.document.leftSide.card[i].isedited = true;
              }
            }
          }
...
//     },
    ...
    taptapeditoractivateright2(item) {
      for (var i = 0; i < this.document.rightSide.card.length; i++) {
      for (var j = 0;j < this.document.rightSide.card[i].section.length;j++) {
        this.document.rightSide.card[i].section[j].tiptapedit = false;
      }
    ...
    taptapeditoractivateright3(item) {
      for (var i = 0; i < this.document.rightSide.card.length; i++) {
      for (var j = 0;j < this.document.rightSide.card[i].section.length;j++) {
        this.document.rightSide.card[i].section[j].tiptapedit = false;
      }
     ...
     taptapeditoractivateright4(item) {
      for (var i = 0; i < this.document.rightSide.card.length; i++) {
      for (var j = 0;j < this.document.rightSide.card[i].section.length;j++) {
        this.document.rightSide.card[i].section[j].tiptapedit = false;
      }
