<template>
  <v-content class="ma-0 pa-0">
    <v-row>
      <v-col cols="2">
  <p class="ml-1 mt-3" style="font-family:raleway;font-size:20px;font-weight:700;">Papierkorb</p>
  </v-col>
  <v-col cols="8">
    </v-col>
    <v-col cols="2">
      <p class="mt-2" style="font-family:raleway;font-size:14px;font-weight:700;">Papierkorb leeren</p>
    </v-col>
  </v-row>
  <!-- <p class="mt-2 ml-1" style="font-family:raleway;font-size:18px;font-weight:700;">Papierkorb</p> -->
           <div v-if="list" class="ml-1">
              <v-row>
                <v-col cols="3">
                  <div style="display: flex">
                    <h3 style="color: #606060">Name</h3>
                    <v-card
                      elevation="0"
                      width="3"
                      height="20"
                    ...
                    <h3 class="ml-2">Kunde</h3>
                  </div>
                </v-col>
                <v-col cols="3">
                  <div style="display: flex">
                    <h3 style="color: #606060">Date</h3>
                    <v-card
                      elevation="0"
                      width="3"
                      height="20"
                    ...
                    <h3 class="ml-2" style="color: #606060">Time</h3>
                  </div>
                </v-col>
                <v-col cols="3">
                  <div style="display: flex">
                    <h3 style="color: #606060">Status</h3>
                    <v-card
                      elevation="0"
                      width="3"
                      height="20"
                    ...
                    <h3 style="color: #606060" class="ml-2">Fortschritt</h3>
                  </div>
                </v-col>
                <v-col cols="3">
                   <h3 style="color: #606060">Arbeitsbereich</h3>
                  </v-col>
              </v-row>
               <div  v-for="(item, index) in current_admin_groups" :key="index">
           <div v-for="(item1, index) in item.contract" :key="index">
                <v-row justify="left" style="cursor: pointer" >
                  <v-col cols="3">
                    <p
                    v-if="contractchecking.includes(item1.copy_contract_front_title +'-'+ item.group_title)"
                      style="text-align: left"
                      class=""
                      @click="currentadmincontracts(item1.copy_contract_title,item.group_title,item1.copy_contract_front_title)"
                    >
                    ...
                    >
                       <v-icon>mdi-file-document-outline </v-icon>
                      {{ item1.copy_contract_title }}_original
                    </p>
                  </v-col>
                  <v-col cols="3">
                    <p style="text-align: left" class="ml-1">20.02.2020</p>
                  </v-col>
                  <v-col cols="3">
                   ...
                   <v-col cols="2">
                  <p style="" class="ml-10">{{item.group_title}}</p>
                   </v-col>
                   <v-col cols="1">
