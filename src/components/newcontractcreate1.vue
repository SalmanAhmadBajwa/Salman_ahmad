...
<template>
  <v-container>
    ...
    <v-layout style="width: 100vw; background-color: #d8d8d8;  z-index:6" class="mt-9">
      <v-card
        elevation="0"
        ...
        >
          <v-card flat>
            <v-card-text v-text="text"></v-card-text>
              ...
              <v-list>
               <v-toolbar  elevation="0"  style="position:fixed; z-index:3; margin-top:4px; background-color:transparent"  >
        <editor-menu-bar 
