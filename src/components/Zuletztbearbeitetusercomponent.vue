      ...
      <v-col cols="3" style="display: flex">
        ...
        >
          <v-btn icon v-if="zuletztbearbeitetmenudown">
            <v-icon class="" color="black" size="28"> mdi-menu-down</v-icon>
          </v-btn>
          <v-btn icon v-if="!zuletztbearbeitetmenudown">
            <v-icon class="" color="black" size="28"> mdi-menu-right</v-icon>
          </v-btn>
        </div>
      </v-col>
    </v-row>
   <div style="display: flex" v-if="zuletztbearbeitetmenudown">
      <div v-for="(item, index) in current_user_recent_contracts" :key="index">
        <v-card
          class="mr-4 mt-4"
          elevation="6"
          height="200"
          ...
          @click="recentcontractforuser(item.title,item.group_title,item.front_title)"
        >
          ...
          >
            <div class="ml-3">
              <p style="color: black">
                <v-icon size="17" class="mt-n1 mr-2" color="black"
...
export default {
name: "Zuletztbearbeitetusercomponent",
data: () => ({
