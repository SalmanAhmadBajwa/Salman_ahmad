<template>
  <v-container>
    ...
    <v-layout style="width: 100vw;  background-color: white;  z-index:0" class="mt-9">
    <sidenavigationbar_admin  v-if="isAdmin && side_navigation_bar"  ></sidenavigationbar_admin>
      ...
      >
                                          ...
                                          <div class="menubar">
                                            ...
                                            >
                                              <v-btn
                                                ...
                                                @click="commands.undo"
                                              >
                                                 <v-icon style="color:black">mdi-undo</v-icon>
                                              </v-btn>
                                              ...
                                              <v-btn
                                                ...
                                                @click="commands.redo"
                                              >
                                                 <v-icon style="color:black">mdi-redo</v-icon>
                                              </v-btn>
                                              <v-btn
                                                icon
                                                v-if="
        ...
        offset-y>
         ...
         <v-icon style="color:black">{{iconH}}</v-icon>
                ...
                <v-list-item >
                                                <v-btn
                                                 ...
                                                 elevation="0"
                                                  ...
                                                  "
                                                >
                                                  <v-icon  style="color:black">mdi-format-header-1</v-icon><v-spacer></v-spacer><span  style="color:black">   Heading 1</span>
                                                </v-btn>     
                </v-list-item>
                <v-list-item>
                                              <v-btn
                                                  ...
                                                  "
                                                >
                                                  <v-icon  style="color:black">mdi-format-header-2</v-icon><v-spacer></v-spacer><span  style="color:black">   Heading 2</span>
                                                </v-btn>     
                </v-list-item>
                <v-list-item>
                                                 <v-btn
                                                 elevation="0"
                                                  ...
                                                  "
                                                >
                                                   <v-icon  style="color:black">mdi-format-header-3</v-icon><v-spacer></v-spacer><span  style="color:black">   Heading 3</span>
                                                </v-btn>     
                </v-list-item>
                <v-list-item>
                                                 <v-btn
                                                  ...
                                                  "
                                                >
                                                  <v-icon  style="color:black">mdi-format-header-4</v-icon><v-spacer></v-spacer><span  style="color:black">   Heading 4</span>
                                                </v-btn>     
                </v-list-item>
              </v-list>
                                              ...
                                              <v-btn
                                                ...
                                                @click="commands.code"
                                                >
                                                 <v-icon style="color:black">mdi-code-tags</v-icon
                                                 >
                                               </v-btn>
                                              ...
                                              <v-btn
                                                ...
                                                "
                                               >
                                               <v-icon style="color:black" x-large>mdi-minus</v-icon>
                                              </v-btn>
      ...
      >
        <template v-slot:activator="{ on, attrs }">
          <v-text-field
            ...
            :value="computedDataFormattedDatefns"
    ...
    <v-row justify="left">
       <v-btn text @click="save_signature()">Speichern </v-btn>
                       ...
                       elevation="0"
                        ...
                        <p class="ml-4" v-if="item.signaturedate">{{computedDataFormattedDatefns}}</p>
        ...
        >
          <v-card flat>
            <v-card-text v-text="text"></v-card-text>
              ...
              <v-list>
               <v-toolbar  elevation="0" class="mt-3 ml-4" style="position:fixed; z-index:3; background-color:transparent" >
        <editor-menu-bar 
      ...
      isActive.table(),
         ...
         <v-icon style="color:black">mdi-file-table-box-outline</v-icon>
        ...
        <v-btn
        icon
          v-if="actionName === 'left'"
          class="menubar__button"
          :class="{'is-active': isActive.alignment(), }"
          @click="commands.alignment({ textAlign: 'left' })"
        >
          <v-icon style="color:black">mdi-format-align-left</v-icon>
        </v-btn>
        <v-btn
        icon
          v-if="actionName === 'center'"
          class="menubar__button"
          :class="{'is-active': isActive.alignment(), }"
          @click="commands.alignment({ textAlign: 'center' })"
        >
        <v-icon style="color:black">mdi-format-align-center</v-icon>
        </v-btn>
        <v-btn
        icon
          v-if="actionName === 'right'"
          class="menubar__button"
          :class="{'is-active': isActive.alignment(), }"
          @click="commands.alignment({ textAlign: 'right' })"
        >
          <v-icon style="color:black">mdi-format-align-right</v-icon>
        </v-btn>
                                              ...
                                              <v-btn
                                               ...
                                               v-bind="attrs"
                                                ...
                                                >
                                                  ...
                                                  <span class="ml-2 mr-2" >Strikethrough</span > 
                                                  </v-tooltip>
                                                <v-tooltip bottom>
                                            <template
                                              v-slot:activator="{ on, attrs }"
...
borderless rounded> 
                                              ...
                                              <v-btn
                                               ...
                                               v-bind="attrs"
                                                ...
                                                >
                                                  ...
                                                  <span class="ml-2 mr-2" >Bullet Text</span > 
                                                  </v-tooltip>
                                                <!-- <v-btn
                                                  icon
                                                  v-if="
      ...
      <v-toolbar elevation="0">
       ...
       <div id="printme">
                  ...
                  >
                    ...
                    <div>             <v-card  elevation="0" >
                                        <div class="editor"
                                           >
                      <p v-if="eyecheck === false" :style="document.rightSide.style">
                      ...
                      >
                       ...
                       <v-row class="mt-n1"  v-if="item.signature && item.signaturename" :justify="item.signatureposition">
                         ...
                         <v-row class="mt-n1"  v-if="item.signature && item.signaturedate" :justify="item.signatureposition">
                           ...
                           <p class="ml-3">{{computedDataFormattedDatefns}}</p>
                        </v-row>
                      </div>
                              ...
                              <div v-if="item1.value">
                                <div v-if="item1.isStrong === true">
                                  <div v-if="item1.heading_property_number">
                                    <div
                                      v-if="item1.tiptapedit"
                                      v-on:click="taptapeditoractivateright(item1,item.id)"
                                    >
                                     <!-- <v-card elevation="0"  > -->
                                        <div class="editor">
                                    ...
                                    <div
                                      v-if="!item1.tiptapedit"
                                      v-on:click="
                                        taptapeditoractivateright(item1,item.id)
                                      "
                                    >
                                      <!-- <p >
                                        <strong
                                      ...
                                      <!-- <v-row justify="center"> -->
                                        ...
                                        > -->
                                          <!-- <v-tooltip left>
      <template v-slot:activator="{ on, attrs }" >
        <v-btn icon class="mt-n2  mr-n2" 
        v-on="on" v-bind="attrs"
        @click="right_side_edit_content(item.id,item1)">
                                      <v-icon >mdi-content-save-edit-outline</v-icon>
                                    </v-btn>
      </template>
      <span class="ml-2 mr-2">Edit Content</span>
    </v-tooltip>
    ...
    <v-tooltip right>
     ...
     <v-btn icon class="mt-n2"
        v-on="on" v-bind="attrs"
      @click="right_side_delete_content(item.id,item1)">
                                      <v-icon >mdi-delete-outline</v-icon>
                                    </v-btn>
      </template>
      <span class="ml-2 mr-2">Delete Content</span>
    </v-tooltip> -->
              ...
              >
                <p class="ml-5 mt-3" style="font-weight: 560">
                  Select statements for editing 
                  <v-row justify="end" class="mt-n3">
                    <v-btn @click="close_edit_content(item1)" icon class="mt-n3 mr-2">
                      <v-icon>mdi-close-circle-outline</v-icon>
                      </v-btn></v-row>
                </p>
                <v-select
                  v-model="rightside_edit_statement_model"
                  :items="leftside_edit_eachpannal_all_statement"
                  item-text="statement"
                  item-value="id"
                  return-object
                  dense
                ...
                <div v-if="rightside_edit_statement_model.length > 0">
                  <p class="ml-5 mt-n1" style="font-weight: 560">
                      Right Side Display will show when following fields are filled
                  </p>
                  <v-select
                    v-model="rightside_edit_triger_statement_model"
                    :items="leftside_edit_triger_eachpannal_all_inner_statement"
                    item-text="mixture"
                    item-value="id"
                    return-object
                    dense
                ...
                <div v-if="rightside_edit_statement_model.length > 0">
                  ...
                  <v-select
                    v-model="rightside_edit_inner_statement_model"
                    :items="leftside_edit_eachpannal_all_inner_statement"
                    item-text="mixture"
                    item-value="id"
                    return-object
                    dense
                ...
                <p
                  ...
                  class="pl-6 mt-n2 mb-n1"
                  v-if="rightside_edit_statement_model.length > 0"
                >
                  Right Side Display 
                </p>
                <div
                ...
                >
                  <v-textarea
                    ...
                    :color="maincolor.theme"
                    auto-grow
                    v-model="right_side_edit_import_data_model"
                    rows="1"
                    dense
                    class="ml-2 mr-1"
                  ></v-textarea>
                                    <!-- :inner-html.prop="right_side_edit_import_data_model" -->
                  <v-btn
                    @click="right_side_edit_option = !right_side_edit_option"
                    icon
                  >
                    <v-icon> mdi-help </v-icon>
                  </v-btn>
                  <v-btn @click="right_side_edit_data_import_func()" icon>
                    <v-icon> mdi-import </v-icon>
                  </v-btn>
                </div>
                <v-card
                  ...
                  min-height="300"
                  style="position: absolute; right: 13.5%; top: 55%; z-index: 3"
                  v-if="right_side_edit_import_data"
                  class="pt-3 pl-3 pr-3"
                >
                  <v-row
                    justify="center"
                    class="mb-n2"
                    v-for="item in data_import_pdf_png_content"
                    :key="item"
                  >
                    <!-- <v-checkbox
                  :value="item"
                  v-model="import_pdf_png_data_model"
                  >
                  </v-checkbox> -->
                    <v-btn
                      icon
                      class="mt-n2"
                      @click="copy_import_edit_data_func(item)"
                    >
                      <v-icon small> mdi-content-copy </v-icon>
                    </v-btn>
                    <p style="text-align: center">{{ item }}</p>
                ...
                >
                  <p style="font-weight: 560">Right Side Display is a Section Heading?</p>
                  <v-radio-group
                    v-model="right_side_edit_section_heading_model"
                    row
                  >
                    <v-radio
                      :color="maincolor.theme"
                      v-for="(n, index) in right_sdie_edit_section_heading"
                      :key="index"
                      :label="n.label"
                      :value="n.value"
                    ></v-radio>
                ...
                <div
                  v-if="
                    rightside_edit_statement_model.length > 0 &&
                    right_side_edit_section_heading_model === 'Nein'
                  "
                  class="ml-6 mt-n1"
                >
                  <p style="font-weight: 560">Right Side Display is a Numbered List?</p>
                  <v-radio-group
                    v-model="right_side_edit_inner_heading_model"
                    row
                  >
                    <v-radio
                      :color="maincolor.theme"
                      v-for="(n, index) in right_side_edit_inner_heading"
                      :key="index"
                      :label="n.label"
                      :value="n.value"
                    ></v-radio>
                ...
                >
                  <p style="font-weight: 560">
Line Breaks</p>
                  <v-radio-group v-model="right_side_edit_line_break_model" row>
                    <v-radio
                      :color="maincolor.theme"
                      v-for="(n, index) in right_sdie_edit_line_break"
                      :key="index"
                      :label="n.label"
                      :value="n.value"
                    ></v-radio>
                ...
                <v-row
                  ...
                  class="mr-2 mt-n3 mb-3"
                >
                  <v-btn text @click="right_side_edit_data_submit()"
                    >submit</v-btn
                  >
                </v-row>
              </v-card>
                                ...
                                <div v-else>
                                  ...
                                  >
                                    ...
                                    >
                                      <div
                                        v-if="
                                          item.section_inner_value_counter_greater_than_one
                                        "
                                      >
                                        <div style="display: flex">
                                          <!-- <v-tooltip left>
                                          ...
                                          <!-- <div
                                            :inner-html.prop="
                                              item1.inner_heading_value_display
                                            "
                                          ></div> -->
                                          <div
                                            :inner-html.prop="item1.display"
            ...
            leftSide: {
              ...
              card: [
                  ...
                  section: [
                    ...
                    },
                    {
                      ...
                      dropselect: [
                        ...
                        {
                          tiptapedit: false,
                          on_which_to_show: "Abweichende Speicherdauer", // will have to look on which to show
                          eid: "s2",
                ...
                },
                {
                  ...
                  signaturedata: "",
                  signaturename:"",
                  signaturedate:format(parseISO(new Date().toISOString()), 'yyyy-MM-dd'),
                  ...
                  section: [
                    {
                      ...
                      display: "",
                      style:
                        "word-break: break-word;text-align: center; font-weight: 00; font-size: 18.72px",
                      isStrong: true,
                      afterlinebreak: 0,
...
updated(){
  ...
  methods: {
    ...
    //      this.html = this.html.replace(removeRegexP, "");
    // },
  ...
  brs[0].parentNode.removeChild(brs[0]);
   ...
   save_signature() {
    ...
    taptapeditoractivateright(item,id) {
      // this.document.rightSide.card[4].section[1].dependent_values[0].display.replace(/(<br>)*/g,"");
