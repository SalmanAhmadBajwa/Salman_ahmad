<template>
        ...
        >
          ...
          >
            <template v-slot:activator="{ on }">
              <v-btn icon v-on="on">
                <v-icon class="" color="#474747">mdi-plus</v-icon>
              </v-btn>
            </template>
        ...
        >
          <template v-slot:activator="{ on }">
            <v-btn
              ...
              class="ml-n8"
            >
              <v-icon class="mr-2 mt-n1" color="#474747"
 ...
 <v-data-table
    ...
    <template v-slot:no-data>
     ...
     <template v-slot:[`item.name`]="{ item }" >
        ...
        <p style="" class="">
              ...
              >
                <v-menu
                  ...
                  offset-x
                  bottom
                  content-class="nameandpasswordchangemenu"
                  rounded="xl"
                  width="293"
                >
                  <template v-slot:activator="{ on }">
                    <div v-on="on">
                      <v-icon class="pt-n2" color="#474747" v-if="recoverItem === item"
                ...
                <v-icon class="mt-n2" color="#474747" v-if="recoverItem !== item"
                  >mdi-account-outline</v-icon
                >
              </v-btn>
              {{ item.name | truncateEnd(12, "...")}} |
            </p>
            <p style="" class="ml-1 mt-2" v-if="recoverItem === item">
              {{ item.password | truncateEnd(12, "...")}}
            </p>
            <p class="mt-2 ml-1" v-else>***********</p>
            </div>
      </template>
       ...
       <template v-slot:[`item.time`]="{ item }" >
        ...
        <template v-slot:[`item.contracts`]="{ item }" >
            <v-card elevation="0" width="500" color="transparent" min-height="1" class="mt-3">
     ...
     <v-btn icon>
              <v-icon @click="permanentdeleteuser(item.id)" color="#474747">mdi-delete-outline</v-icon>
            </v-btn>
       </template>
 </v-data-table>
  </v-main>
...
export default {
  ...
  methods: {
   watchfunctionforuser() {
      ...
      var user = JSON.parse(JSON.stringify(store.state.current_admin_users));
      var len = user.length;
      for (var i = 0; i < len; i++) {
        var array = []
   ...
   change_name_and_password(
      ...
      if (
        ...
        type: 'error', 
        title: 'Féhler', 
        message: 'Gleicher Benutzername gefunden!', 
        detail:  changeusername + 'ist bereits vorhanden', 
      });
        }
      } else if (
    ...
    delete_group(x) {
      ...
      if (confirmation == true) {
        ...
        detail:  group.group_title + 'ist gelöscht' , 
      });
        this.group_title = "";
        this.auto_users = [];
        this.auto_contracts = [];
