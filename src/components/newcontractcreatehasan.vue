  ...
  <v-container>
    ...
    <v-layout style="width: 100vw; background-color: #d8d8d8" class="mt-9">
          ...
          >
            ...
            >
              <div
                ...
                "
              ></div>
              <v-expansion-panels v-model="opened_pannal" class="ml-n3" flat accordion>
                <draggable
      ...
      <v-list-item
        ...
        v-ripple="{ class: `${color}--text` }"
      >
         <p class="pt-4"  @click.stop="onClick()" 
          v-on:dblclick="
     ...
     <v-list v-if="item.name_edit">
      <v-list-item
        ...
        v-ripple="{ class: `${color}--text` }"
      >
     <div class="pt-10 pb-3 mr-5" @click.stop="onClick()" v-click-outside="onClickOutside3">
                              <tiptap-vuetify
                          ...
                          >
                            ...
                            <div v-if="edit" style="word-break: break-word">
                              <p
                                ...
                                v-on:dblclick="
                                  taptapeditoractivateleft(item1)
                                "
                            ...
                            <div class="row" v-if="item1.type === 'checkbox'">
                              ...
                              >
                                <div v-if="edit">
                                  ...
                                  <div v-if="!item2.tiptapedit">
                                    <div class="row">
                                     <v-icon class="mt-n4">mdi-checkbox-blank-outline</v-icon>
                                     <p  
                                     class="pl-2"
                                     v-on:dblclick="
                                            taptapeditoractivateleft(item2)
  ...
  methods: {
    onClickOutside3(){
      ...
      for (i = 0; i < this.document.leftSide.card.length; i++) {
          ...
          var obj = this.document.rightSide.card[i].section.find((o) => o.dependent_values[0].display === this.document.rightSide.card[i].name )
   ...
   onClickOutside(){
        ...
        for(j=0 ; j< this.document.leftSide.card[i].section.length ; j++){
          ...
          if (this.document.leftSide.card[i].section[j].dropselect_display ===true) {          
            for (k = 0;k <this.document.leftSide.card[i].section[j].dropselect.length;k++) {
             if(this.document.leftSide.card[i].section[j].dropselect[k].tiptapedit === true){
          ...
          // radio
          if (this.document.leftSide.card[i].section[j].fields_display ===true && this.document.leftSide.card[i].section[j].type === 'radio') {          
            for (k = 0 ;k <this.document.leftSide.card[i].section[j].fields.length;k++) {
              if(this.document.leftSide.card[i].section[j].fields[k].tiptapedit === true){
                this.document.leftSide.card[i].section[j].fields[k].tiptapedit = false;
                this.document.leftSide.card[i].isedited = true
              }
            }
            if(this.document.leftSide.card[i].section[j].dropselect_display === true){
              if(this.document.leftSide.card[i].section[j].dropselect[0].tiptapedit === true){
                this.document.leftSide.card[i].section[j].dropselect[0].tiptapedit = false
                this.document.leftSide.card[i].isedited = true
              }
            }
            if(this.document.leftSide.card[i].section[j].textfieldapproval === true){
              if(this.document.leftSide.card[i].section[j].textfieldapprovalfields[0].tiptapedit === true){
                this.document.leftSide.card[i].section[j].textfieldapprovalfields[0].tiptapedit = false
                this.document.leftSide.card[i].isedited = true
              }
            }
          }
          //checkbox
          if (this.document.leftSide.card[i].section[j].fields_display ===true && this.document.leftSide.card[i].section[j].type === 'checkbox'){
            for (k = 0 ;k <this.document.leftSide.card[i].section[j].fields.length;k++) {
              if(this.document.leftSide.card[i].section[j].fields[k].tiptapedit === true){
                this.document.leftSide.card[i].section[j].fields[k].tiptapedit = false;
                this.document.leftSide.card[i].isedited = true
    ...
    importcardfromanothercomponenttwoways(card_name, contract_name, checkboxvalue , item){
      // console.log("aa")
      var local_array = [];
      ...
      for(var i=0; i< local_array.length ;  i++){
        this.importcardfromanothercomponent(local_array[i],contract_name, item)
      }
      this.card_name = "";
      this.contract_name = "";
      this.checkboxvalue = [];
    ...
    eyefunc(item) {
      this.document.leftSide.card[item - 1].eye = !this.document.leftSide.card[
        item - 1
      ].eye;
      this.document.rightSide.card[item - 1].eye = !this.document.rightSide
        .card[item - 1].eye;
    },
    drag_functionstart() {
      this.dragging = true;
