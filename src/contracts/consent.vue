<template>
 ...
 <div class="mt-n3" style="display:flex;" v-for="(item,index) in conclusionnewitems2" :key="index">
                 ...
                 <v-btn class="mt-n2" @click="editmode7 = !editmode7"  icon v-if="edit">
                      <v-icon size="19">mdi-pencil-outline</v-icon>
                    </v-btn> 
                    <v-textarea
                    v-if="editmode7"
                  ...
                  <p v-else style="word-break: break-word;">{{ consent.addressnewheading4 }}</p>
                    ...
                    <div class="mt-n3" style="display:flex;" v-for="(item,index) in conclusionnewitems3" :key="index">
                  <v-btn 
                   @click="editmode8 = index"
                  style="margin-top:-0.45em;" icon v-if="edit">
                      <v-icon  size="19">{{item.icon}}</v-icon>
                    </v-btn>
                  <v-radio-group v-model="consent.newselection3">
                  <v-radio
                        color="#FFA300"
                        class=""
                        :rules="rules"
                ...
                <v-expansion-panel-header @click="offerpannalchangevalue()">
                  ...
                  <div >
                   ...
                   auto-grow
                    ...
                    style="margin-left:-35%;"
                     @keydown.enter.exact.prevent
                     @keydown.enter.shift.exact="newlineDescription(consent.offerpannalname)"
                  ...
                  <span
                   v-else ><strong>{{ consent.offerpannalname | truncateEnd(36, "...")  }}</strong></span
                  >
                  </div>
                          ...
                          <v-list>
                            <v-list-item>
                              <p class="mt-2" style="text-align: left">
                                Bei dem "Verantwortlichen für Datenschutz" handelt es sich
                                meist um ihr Unternehmen selbst.
                              </p>
                            </v-list-item>
                          </v-list>
                        </v-card-text>
                  ...
                  <v-list-item>
                    ...
                    <!-- §{{consent.pos[0]}}<br> -->
                      <p
                        ...
                        style="word-break: break-word;text-align: center; font-weight: 700;font-size: 16px"
                      >
                <strong> Einwilligung in die Verwendung von Mitarbeiter{{ consent.newselection1.var2 }}</strong>
                      </p>
                      ...
                      <p
                        ...
                        ><br> Die{{ consent.addressnewFirmenname }} {{ consent.addressnewRechtsform }} beabsichtigt, 
                        zur Darstellung des Unternehmens{{ selected.join(" / ") }}  {{ consent.newmenu1 }}
                        {{ consent.newselection1.var1 }} zu erstellen und zu veröffentlichen, auf denen
                        Mitarbeiter zu sehen sind.
                        
                      </p>
                      
                       <p
                        v-if="consent.newselection3"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      >
                        Im Rahmen dieser Veröffentlichung sollen die
                        abgebildeten Mitarbeiter auch vorgestellt werden.
                        Hierdurch soll eine bessere Kundenbindung
                        erreicht werden, indem die Kunden sich ein
                        besseres Bild von ihrem Ansprechpartner machen
                        können.
                      </p>
                       
                       <p
                        v-if="consent.newselection3 === false"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      >
                       Dabei erfolgt keine Nennung der Namen der
                       abgebildeten Mitarbeiter und es werden nicht
                       gezielt einzelne Mitarbeiter vorgestellt.
                      </p>
                      
                      <p
                        v-if="consent.newselection3 ===true || consent.newselection3 === false"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       1. Ich willige ein, dass zu diesem Zweck die {{ consent.newselection1.var1 }},
                       in denen ich zu sehen bin, {{ selected.join(" / ") }} {{ consent.newmenu1 }} abgebildet werden.
                      ...
                      style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       2. Mir ist bekannt, dass Informationen im Internet weltweit zugänglich sind, 
                       mit Suchmaschinen gefunden und mit anderen Informationen verknüpft werden können, 
                       woraus sich unter Umständen Persönlichkeitsprofile über mich erstellen lassen. Ins Internet gestellte
                       Informationen, einschließlich Fotos, können problemlos kopiert und weiterverbreitet
                       werden. Es gibt spezialisierte Archivierungsdienste, deren Ziel es ist, den
                       Zustand bestimmter Websites zu bestimmten Terminen dauerhaft zu dokumentieren. Dies
                       kann dazu führen, dass im Internet veröffentlichte Informationen auch nach ihrer
                       Löschung auf der Ursprungs-Seite weiterhin aufzufinden sind.
                      <p
                      v-if="consent.newselection3 ===true || consent.newselection3 === false"
                      style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      > <br>
                       3. Die Einwilligung in die Nutzung zum oben genannten Zweck ist freiwillig. Wenn der
                       Mitarbeiter in die Verwendung des {{ consent.newselection1.var1 }}
                       nicht einwilligt, so wirkt sich dies nicht negativ auf das
                       Arbeitsverhältnis zwischen den Parteien aus.
                      <p
                      v-if="consent.newselection3 ===true || consent.newselection3 === false"
                      style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      > <br>
                       4. Ich kann meine Einwilligung jederzeit in Textform (z. B. Brief, E-Mail) widerrufen.
                       {{ consent.newselection1.var1 }}, in denen ich erkennbar bin und die im Wesentlichen nur
                       ...
                       entfernt und nicht mehr für neue Drucksachen verwendet. Sofern
                       ich auf einem der {{ consent.newselection1.var1 }},
                       zusammen mit anderen Personen abgebildet bin, müssen diese {{ consent.newselection1.var1 }}
                       nicht entfernt werden, sondern es genügt, wenn
                       ich unverzüglich auf den {{ consent.newselection1.var1 }} unkenntlich gemacht werde 
                       (z. B. durch Verpixelung). Bin ich auf einem der {{ consent.newselection1.var1 }} zusammen mit anderen Personen
                       abgebildet und möchte die {{ consent.addressnewFirmenname }} {{ consent.addressnewRechtsform }}
                       die Möglichkeit zur Verpixelung nicht nutzen, beträgt die Frist für
                       den Austausch des Fotos sechs Monate, bei einem Video 1 Jahr.
                      <br />
                      <br />
                      <br />
                      <br />
                      <br />
                      <br />
                      ____________________________  <span style="padding-left:22px">______________________________</span>
                      ...
                      <p
                        ...
                        "
                      >
                        {{ consent.addressStrasse }} {{ consent.addressHausnummer }}
                      </p>
                      <p
                        style="
                          font-size: 20px;
                      ...
                      <br>
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>1. Rechtsgrundlage für die Speicherung, sowie die Verarbeitung der vertragsgegenständlichen
                       {{ consent.newselection1.var1 }} ist Ihre Einwilligung in Verbindung mit Art. 6 Abs. 1 S. 1 lit. a DSGVO.

                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      >
                        2. Verantwortlicher für die Speicherung und die Verarbeitung der vertragsgegenständlichen {{ consent.newselection1.var1 }} iSd DSGVO ist: 
                      ...
                      <p
                        ...
                        "
                      ><br>
                        <strong>{{ consent.addressnewVorname }} {{ consent.addressnewNachname }}</strong>
                      </p>
                      <p
                        style="
                          font-size: 15px;
                        ...
                        "
                      >  
                      <strong>{{ consent.addressnewStrasse }} {{ consent.addressnewHausnummer }}</strong>
                      </p>
                      <p
                        style="
                          font-size: 15px;
                        ...
                        "
                      >  
                      <strong>{{ consent.addressnewPLZ }} {{ consent.addressnewOrt }}</strong>
                      </p>
                      <p
                        style="
                          font-size: 15px;
                        ...
                        "
                      >  
                      <strong>{{ consent.addressnewTelefonnummer }} {{ consent.addressnewEmail }}</strong>
                      </p>
                      ...
                      ><br>
                       ...
                       {{ consent.newselection1.var1 }}erfolgt für die Dauer, die für
                       Erreichung des oben dargestellten
                       Nutzungszwecks erforderlich sind oder bis sie
                       Ihre Einwilligung gemäß dieses Verträges
                       widerrufen haben.
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       ...
                       4. Nach den Regelungen des Bundesdatenschutzgesetzes und der
                       Datenschutzgrundverordnung stehen Ihnen verschiedene Rechte in Bezug auf die
                       vertragsgegenständlichen {{ consent.newselection1.var1 }} zu:
                      <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       (1) Aus Art. 15 Abs. 1 DSGVO haben Sie einen Anspruch auf konstenlose
                       Auskunfserteilung über Ihre gespeicherten Daten, sowie gemäß Art. 15 Abs. 3 DSGVO
                       das Recht auf eine Kopie dieser Datenaufstellung zu erhalten.
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       (2) Gemäß Art. 16 DSGVO stehen Ihnen auch ein Anspruch auf Berichtigung
                       der von uns verarbeiteten Daten zu. Demnach sind Sie dazu berechtigt, Ihre Daten
                       zu berichtigen oder vervollständigen, wenn sie falsch oder unvollständig sind.
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       (3) Gemäß Art. 17 DSGVO haben Sie das Recht, von uns die Löschung Ihrer von uns
                       verarbeiteten personenbezogenen Daten zu verlangen.
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       (4) Nach Art. 18 DSGVO können Sie von uns unter bestimmten Umständen die Einschränkung
                       der Verarbeitung Ihrer personenbezogenen Daten verlangen.
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                       (5) Nach Art. 21 DSGVO haben Sie unter bestimmten Umständen ein Widerspruchsrecht 
                       gegen die Verarbeitung Sie betreffender personenbezogener Daten.
                       <p
                        v-if="consent.addressnewVorname || consent.addressnewNachname || consent.addressnewOrt"
                        style="word-break: break-word;text-align: justify; margin-top: 0.5%"
                      ><br>
                      (6) Möchten Sie ihre Rechte geltend machen, wenden Sie sich bitte per 
                          E-Mail an: {{ consent.addressnewEmail }} 
                     </p>
                      <!-- end of pannal 7new -->
                    </v-list-item-content>
                  </v-list-item>
...
// mounted
  ...
  data: () => ({
    ...
    addressnewheading2: "Sollen von den Mitarbeitern Fotos oder Videos erstellt werden?",
    addressnewheading3: "Wofür sollen die erstellten Fotografien/Videos verwendet werden?",
    addressnewheading4: "Sollen die Namen der auf den Bildern abgebildeten Mitarbeiter unter dem Bild genannt werden?",
    addressnewheading5: "Geben Sie die Informationen des Verantwortlichen für die Datenverarbeitung an",  
      addressPlz: "",
      addressOrt: "",
...
conclusionnewitems2: [
  ...
  watch: {
    ...
    addresspannalprogress: function(){
      ...
      //addresspannalfields.push(this.consent.newselection1);
      addresspannalfields.push(this.consent.newselection3);
